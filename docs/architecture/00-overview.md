...
| --- | --- | --- |
| Simulation behaviour | `js/sim/simconfig.js` | `SIM`, `WEIGHT`, `ECON`, `MOTIVE`, `MEMORY`, `HEARSAY`, `FACTIONS`, `FACTION_RELATIONS`, `PROFESSIONS`, `GOODS`, `COMMODITIES`, `BASE_PRICE`, `MONSTER`, `ROSTER`, `TOWNS`, `CAMPS`, `DUNGEON` |
